...
export const loadCaptchaEnginge = (
  ...
  let retVal = '';
  //   remove characters o, l, i, O, L, I and number 0
  let charset = 'abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ123456789';
  if (charMap === 'upper') {
    charset = 'ABCDEFGHJKMNPQRSTUVWXYZ123456789';
  } else if (charMap === 'lower') {
    // remove lowercase i l o
    charset = 'abcdefghjkmnpqrstuvwxyz123456789';
...
export const validateCaptcha = (userValue, reload = true) => {
  ...
  if (userValue?.toLowerCase() != captcha_value?.toLowerCase()) {
    if (reload == true) {
